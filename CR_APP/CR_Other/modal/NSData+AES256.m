...
#define PASSWORD [NSData getDateResult]
...
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain {
	...
	if (cryptStatus == kCCSuccess) {
		...
		return [encryptData AESbase64Encoding];
	}
...
/*解密方法*/
+ (NSData *)AES256DecryptWithCiphertext:(NSString *)ciphertexts{
...
+ (NSString *) getDateResult{
    NSDateFormatter *year = [[NSDateFormatter alloc] init];
    [year setTimeZone:[[NSTimeZone alloc] initWithName:@"UTC"]];
    [year setDateFormat:@"yyyy"];
    
    NSDateFormatter *month = [[NSDateFormatter alloc] init];
    [month setTimeZone:[[NSTimeZone alloc] initWithName:@"UTC"]];
    [month setDateFormat:@"MM"];
    
    NSDateFormatter *day = [[NSDateFormatter alloc] init];
    [day setTimeZone:[[NSTimeZone alloc] initWithName:@"UTC"]];
    [day setDateFormat:@"dd"];
    NSDate *now = [NSDate date];
    
    NSInteger yearNum = [[year stringFromDate:now] integerValue];
   
    NSInteger monthNum = [[month stringFromDate:now] integerValue];
 
    NSInteger dayNum = [[day stringFromDate:now] integerValue];
    
    NSNumber *result=[NSNumber numberWithInteger:(yearNum*monthNum*dayNum)];
    
    return [NSMutableString stringWithFormat:@"qT44YYQtw8YFq9B6QmGFdQ%@",[result stringValue]];
