...
- (void) startAnimationForIndeterminateMode
{
    ...
    self.progressCounter = (0.18181818 * (float)_progressTotal);
...
- (void)notifyProgressChange
{
    ...
    if (self.labelTextBlock) {
        ...
        float percentageCompleted = ((float)100.0f / self.progressTotal) * self.progressCounter;
